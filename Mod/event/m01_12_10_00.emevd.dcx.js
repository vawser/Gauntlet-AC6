...
Event(0, Default, function() {
    ...
    EsdTriggeredCommonEvent(0, 5420, 0);
    ...
    EsdTriggeredCommonEvent(0, 5300, 200010, 0);
    EsdTriggeredCommonEvent(0, 5610, 0);
    EsdTriggeredEvent(0, 2000, 0);
    EsdTriggeredEvent(0, 2005, 0);
    EsdTriggeredEvent(0, 2001, 0);
    EsdTriggeredEvent(0, 2003, 0);
    EsdTriggeredEvent(0, 2020, 0);
    EsdTriggeredEvent(0, 2021, 0);
    EsdTriggeredEvent(0, 2022, 0);
    EsdTriggeredEvent(0, 2050, 0);
    EsdTriggeredEvent(0, 2051, 0);
    EsdTriggeredEvent(0, 2052, 0);
    EsdTriggeredEvent(0, 2053, 0);
    EsdTriggeredEvent(0, 2030, 0);
    EsdTriggeredEvent(0, 2031, 0);
    EsdTriggeredEvent(0, 2032, 0);
    EsdTriggeredEvent(0, 2033, 0);
    EsdTriggeredEvent(0, 2300, 0);
    EsdTriggeredEvent(0, 2301, 0);
    EsdTriggeredEvent(0, 2302, 0);
    EsdTriggeredEvent(0, 2310, 0);
    EsdTriggeredEvent(0, 2311, 0);
    EsdTriggeredEvent(0, 2312, 0);
    EsdTriggeredEvent(0, 2044, 0);
    EsdTriggeredEvent(0, 2045, 0);
    EsdTriggeredEvent(0, 2046, 0);
    EsdTriggeredEvent(0, 2047, 0);
    EsdTriggeredEvent(0, 2060, 0);
    ...
    EsdTriggeredEvent(0, 2090, 0);
    EsdTriggeredEvent(0, 2091, 0);
    EsdTriggeredEvent(0, 2500, 0);
    EsdTriggeredEvent(0, 2501, 0);
    EsdTriggeredEvent(0, 2502, 0);
    EsdTriggeredEvent(0, 2503, 0);
    ...
    EsdTriggeredEvent(0, 2650, 1000, 1001);
});
...
Event(2001, Default, function() {
    ...
    SetCharacterAIState(500, Disabled);
    SetCharacterAIState(505, Disabled);
    SetCharacterAIState(506, Disabled);
});
...
Event(2030, Default, function() {
    ...
    SetSpEffect(500, 9991003);
});

Event(2031, Default, function() {
    SetSpEffect(510, 9991003);
    SetSpEffect(511, 9991003);
    SetCharacterAIState(510, Enabled);
    SetCharacterAIState(511, Enabled);
    Unknown20041021(510, 10000, -1082130432, 0);
    Unknown20041021(511, 10000, -1082130432, 0);
});
...
Event(2046, Default, function() {
    ...
    SetCharacterAIState(510, Disabled);
    SetCharacterAIState(511, Disabled);
});
...
Event(2060, Default, function() {
    ...
    SetCharacterAIState(500, Enabled);
    SetCharacterAIState(505, Enabled);
    SetCharacterAIState(506, Enabled);
});
...
Event(2310, Default, function() {
    Unknown41004(251, 20000, 510, 3);
    Unknown41004(251, 20000, 511, 3);
